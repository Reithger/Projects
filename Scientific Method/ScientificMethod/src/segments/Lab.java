...
public class Lab extends TimerTask{
	...
	public Lab(BufferedImage map, int ranking, ArrayList<Character> incomingHelp, SocializationScreen soc, String filePath){
			  ...
			  boolean stationLocation = true;
				...
				if(stationLocation){
				  if(count == 0){
					count++;
					continue;}
				  stations.add(new Station(1 + rankInstance / 5 + rand.nextInt(1 + ranking / 100), j * 4, i * 4, STATION_LIFE_TIME, filePath));
				  count++;
		}	}	}	}
		count--;
