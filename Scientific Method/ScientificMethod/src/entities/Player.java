...
public class Player extends Entity{
	...
	public Player(int x, int y, String imageLocation, String filePathIn){
	...
	private void setGender(int index){						//Identity matrix 1'st decides Gender data
		...
		for(int i = 0; i < identity[1].length; i++)
			if(identity[1][i])
				loc = i;
		switch(loc){
		  case 0: setVisual(filePath + "Assets/Entities/Male/"); break;
		  case 1: setVisual(filePath + "Assets/Entities/Female/"); break;
		  case 2: setVisual(filePath + "Assets/Entities/NonBinary/"); break;
		  default: break;
		}
