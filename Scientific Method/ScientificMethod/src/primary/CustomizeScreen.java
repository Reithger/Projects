...
public class CustomizeScreen extends InteractFrame{
	...
	public CustomizeScreen(String title, JFrame parentFrame, Object paused, String filePath){
		super(filePath);
		...
		sci = new Player(SCREEN_WIDTH/2, SCREEN_HEIGHT/2, filePath + "/Assets/Entities/Male/", filePath);
		sci.adjustVisual();
